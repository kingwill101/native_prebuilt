...
void main() {
  group('generateManifest with platform-specific built library layout', () {
    ...
    test('generateManifest finds library in platform-specific subdirectory', () async {
      ...
      expect(manifest.artifacts['android-arm64']!.archiveName,
          'tdlib-android-arm64.tar.gz');
    });

    test('generateManifest falls back to flat layout for backwards compatibility', () async {
    ...
    test('generateManifest fails with clear error when library missing entirely', () async {
